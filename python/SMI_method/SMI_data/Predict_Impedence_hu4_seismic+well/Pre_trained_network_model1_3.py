...
from net_and_data import MyDataset2, BSsequential_net_lstm, device, weights_init
from my_loss_function import my_mse_loss_fun, syn_seismic_fun2

BATCH_SIZE = 1  # BATCH_SIZE大小
BATCH_LEN = 30  # BATCH_LEN长度
EPOCHS = 50000  # 总共训练批次
coefval = 0.4  # 相关系数阈值
Rval = 50  # 半径阈值
num_well = 5  # 井数量
...
def tested():
    ...
    pathmat = './SMI_out/test_X16_Impedance_model1_2020_07_31_0%d.mat' % date_num
    scipio.savemat(pathmat, {'test_X16_Impedance_model1_2020_07_31_0%d' % date_num: impedance_xline16})
...
def tested2():
    ...
    pathmat = './SMI_out/pre_X76_Impedance_model1_2020_07_31_0%d.mat' % date_num
    scipio.savemat(pathmat, {'pre_X76_Impedance_model1_2020_07_31_0%d' % date_num: impedance_xline76})
...
def tested3():
    ...
    pathmat = './SMI_out/pre_In26_Impedance_model1_2020_07_31_0%d.mat' % date_num
    scipio.savemat(pathmat, {'pre_In26_Impedance_model1_2020_07_31_0%d' % date_num: impedance_inline26})
