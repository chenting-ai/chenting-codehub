...
if isempty(param.shading)
   cplot_no1(yi,seismic.first,dti,xi,param.direction, ...
         param.limits,ha)
else
   cplot_no2(yi,seismic.first,dti,xi,param.direction, ...
...
function cplot_no1(seis,stm,prm,xannot,plot_dir,param_scale,ha)
...
function cplot_no2(seis,stm,prm,xannot,plot_dir,param_scale,ha,param_shading)
